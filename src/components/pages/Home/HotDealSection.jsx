        ...
        <div className='max-w-screen-xl mx-auto'>
            <div className='grid md:grid-cols-2 text-center gap-4 md:px-1'>
                <div className='mt-14 md:mt-24'>
                    <h1 className="text-5xl lg:text-7xl font-bold mb-6">Hot Deal ! Sale Up To <span className='text-[#e53e29]'>25% Off</span></h1>
                ...
                <div className='w-full mt-10 md:mt-0 md:h-[615px]'>
                    <img
                        src='/image/man.webp'
                        alt=''
