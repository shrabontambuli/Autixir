    ...
    <div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-24">
          <div className="flex justify-center items-center border border-[#e53e29] hover:shadow-2xl hover:border-none transition-all h-40">
            ...
            <div>
              <div className="p-4">
                ...
                <h2 className="text-xl font-semibold hover:text-[#e53e29] mt-2">Wheel Bearing Reta</h2>
                <h4 className="text-lg text-[#e53e29] font-medium mt-2">$118.26 <span className="line-through text-[#eea69c] ms-2">
                $162.00 </span></h4>
              </div>
            </div>
          </div>
